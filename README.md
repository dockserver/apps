# DOCKER-COMPOSER FILES FOR DOCKSERVER

---

## HOW TO USE [[ EASY AND SIMPLE MODE ]]
```sh
export alias appinstall='curl -s https://raw.githubusercontent.com/dockserver/apps/master/appinstall.sh >> /tmp/app && bash /tmp/app' >> ~/.bashrc
source ~/.bashrc
